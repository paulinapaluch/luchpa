classdef MRDataCineReadDicoms_Miccai2009online < matlab.unittest.TestCase
    ...
    properties (TestParameter)
        ...
        dcmDir = {'/Volumes/Seagate/DCM/Challenges/MICCAI 2009 LV SEG/challenge_online/challenge_online'};
        matDir = {'/Volumes/Seagate/MAT/unitTesting/Miccai2009'};
        conDir = {'/Volumes/Seagate/DCM/Challenges/MICCAI 2009 LV SEG/Sunnybrook Cardiac MR Database ContoursPart1/OnlineDataContours'};
    ...
    methods (Test)
        ...
        function testMICCAI2009_data1(tc,dcmDir,matDir)
            ...
            %%% namesize( 9,:) = {'SC-HYP-9',    [256 256 12 20]}; % series 300 is ok
        ...
        function testMICCAI2009_data2(tc,dcmDir,matDir)
            ...
            %%% namesize( 8,:) = {'SC-HF-NI-15', [256 256 11 20]};
            namesize( 9,:) = {'SC-HYP-9',    [256 256 12 20], {300}}; % series 300 is ok
            %%% namesize(10,:) = {'SC-HYP-10',   [256 256  9 20]};
            %%% namesize(11,:) = {'SC-HYP-11',   [256 256 14 20]};
            %%% namesize(12,:) = {'SC-HYP-12',   [256 256  9 20]};
